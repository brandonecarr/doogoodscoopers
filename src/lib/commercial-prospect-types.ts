...
export const PROSPECT_STATUSES = ["TO_CALL", "ATTEMPTED", "LEFT_VOICEMAIL", "CONTACTED", "INTERESTED", "NOT_INTERESTED", "CONVERTED", "ARCHIVED"] as const;
...
export const PROSPECT_STATUS_META: Record<ProspectStatus, { label: string; dot: string; badge: string }> = {
  ...
  LEFT_VOICEMAIL: { label: "Left voicemail", dot: "bg-yellow-500", badge: "bg-yellow-100 text-yellow-800" },
