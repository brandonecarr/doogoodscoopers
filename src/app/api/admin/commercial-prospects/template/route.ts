...
export async function GET() {
  ...
  const csv = ["property,type,contact,phone,email,city,state,zip,units,notes,source",
    "Sierra Lakes HOA,HOA,Board manager name,(909) 555-0100,manager@example.com,Fontana,CA,92336,240,Allows dogs; pet stations on site,hoa-directory.example",
